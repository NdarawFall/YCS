    ...
    <div className="flex min-h-screen flex-col bg-[#08080c] text-[#ececf1] relative">
      ...
      <main className="flex-1">
          ...
          <FadeInWrapper className="mx-auto max-w-6xl px-5 py-16 sm:px-8 md:py-24">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div className="glass p-8 rounded-3xl border border-white/10">
                    <p className="text-lg text-white/70 italic">"Marvid a transformé notre flux de travail. On ne perd plus de temps sur l'organisation."</p>
                    <p className="mt-4 font-semibold text-white">- Un créateur satisfait</p>
                </div>
                <div className="glass p-8 rounded-3xl border border-white/10">
                    <p className="text-lg text-white/70 italic">"Indispensable pour gérer mon équipe de montage. Une clarté incroyable."</p>
                    <p className="mt-4 font-semibold text-white">- Un YouTuber pro</p>
                </div>
            </div>
          </FadeInWrapper>
        </section>
        ...
        <section className="border-b border-white/[0.06]">
          <FadeInWrapper className="mx-auto max-w-3xl px-5 py-16 sm:px-8 md:py-24">
            <Reveal>
              <div className="text-center mb-16">
            ...
            <div className="space-y-6">
                <div className="border-b border-white/10 pb-4">
                    <h3 className="text-lg font-semibold text-white">Est-ce gratuit pour commencer ?</h3>
                    <p className="mt-2 text-white/60">Oui, vous pouvez commencer gratuitement pour une chaîne.</p>
                </div>
                <div className="border-b border-white/10 pb-4">
                    <h3 className="text-lg font-semibold text-white">Est-ce compatible avec mon équipe ?</h3>
                    <p className="mt-2 text-white/60">Absolument, le mode équipe est conçu pour collaborer efficacement.</p>
                </div>
            </div>
          </FadeInWrapper>
        </section>
